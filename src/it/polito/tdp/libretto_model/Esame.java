...
//oggetto semplice che contiene i dati relativi ad un singolo esame
	...
	//oggetto con dati privati(proprietà)
	//costruttore
	//getter and settere
	//+metodi servizio
	//metodi si servizio (toString, equals, hascode, (compareTo))
	public class Esame {
		 ...
		 * @param titolo titolo denominazione cel corso
		 * @param docente cognome e nome del docente
		 */
		...
		/**
		 * Se l'esame non è ancora superato , lo si considera superato
		 * con il voto e la data specificati.
		 * se invece era già superato, genera un eccezione
		 * 
		 * @param voto
		 * @param data
		 */
